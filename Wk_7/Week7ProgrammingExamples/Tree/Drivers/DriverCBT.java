...
public class DriverCBT
{
	public static void main(String[] args)
	{
		...
		CloneableBinaryTree<String> treeClone = (CloneableBinaryTree<String>)aTree.clone();
		showTreeStats(treeClone, "A", 4, 8);
		testLevelOrder(treeClone, "A B C D E F G H");
		testPreorder(treeClone,   "A B D H E C F G");
		testInorder(treeClone,    "D H B E A F C G");
		testPostorder(treeClone,  "H D E B F G C A");
		...
		treeClone.setRootData("Y");
		showTreeStats(treeClone, "Y", 4, 8);
		testLevelOrder(treeClone, "Y B C D E F G H");
		testPreorder(treeClone,   "Y B D H E C F G");
		testInorder(treeClone,    "D H B E Y F C G");
		testPostorder(treeClone,  "H D E B F G C Y");
	...
	public static void showTreeStats(CloneableBinaryTree<String> tree,
                                    String root, int height, int numberOfNodes)
	{
		if (tree.isEmpty())
		...
		System.out.println("# nodes in tree is " + tree.getNumberOfNodes()
				+ "; s/b " + numberOfNodes);
	} // end showTreeStats 
