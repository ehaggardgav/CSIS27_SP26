...
public class DriverGT
{
	...
	public static void testTraversals(GeneralTreeInterface<String> aTree,
                                     String preorder, String postorder)
	{
		testPreorder(aTree,  preorder);
		testPostorder(aTree, postorder);
	} // end testTraversals

	public static void showTreeStats(GeneralTreeInterface<String> tree,
                                    String root, int numberOfNodes)
	{
		if (tree.isEmpty())
