...
/**
   ...
   and that is the second solution to Project 2 of Chapter 25.
   This class uses the class GuessingGameTree, which is derived from DecisionTree.
...
public class GuessingGame
{
	...
	{
      String response;
      GuessingGameTree gameTree = new GuessingGameTree("Is it in North America?", "Brazil", "U.S.A.");
      do
      {
   ...
   public static GuessingGameTree play(GuessingGameTree gameTree)
   {
      ...
      // Assertion: gameTree.isAnswer() == true, that is, a leaf is reached
   ...
   public static void learn(GuessingGameTree gameTree)
   {
      System.out.println("I give up; what are you thinking of? ");
      String correctAnswer = getUserResponse();
      String currentAnswer = (String)gameTree.getCurrentData();
      ...
      gameTree.extendTree(newQuestion, currentAnswer, correctAnswer);
   } // end learn
