/** 
   A driver that demonstrates the class SortArray.
...
public class Driver2
{
   ...
   public static void testSort(int sort, boolean print, String name, int n)
   {
      ...
      switch (sort)
      {
         ...
         case 2: SortArray.selectionSort2(array, n); break;
         case 3: SortArray.insertionSort(array, n); break;
         case 4: SortArray.insertionSort2(array, n); break;
         case 5: SortArray.recursiveBubbleSort(array, n); break;
         case 6: SortArray.mergeSort(array, n); break;
         case 7: SortArray.quickSort(array, n); break;
      } // end switch
